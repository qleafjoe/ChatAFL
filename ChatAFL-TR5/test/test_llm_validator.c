...
static void test_rtsp(void) {
    ...
    /* --- Missing Transport for SETUP (TR5: CONTEXT_FAIL, recoverable) --- */
    ...
    r = validate_llm_message("RTSP", LLM_STAGE_GRAMMAR,
        ...
        "\r\n",
        &ctx);
    ASSERT_CONTEXT_FAIL(r, "Missing Transport for SETUP");

    /* --- Missing Session for PLAY (TR5: CONTEXT_FAIL, recoverable) --- */
    ...
    /* --- Missing Session for PAUSE (TR5: CONTEXT_FAIL, recoverable) --- */
    ...
    /* --- Missing Session for TEARDOWN (TR5: CONTEXT_FAIL, recoverable) --- */
