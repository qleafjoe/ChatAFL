...
PFBENCH=$PFBENCH PATH=$PATH LLM_URL="$LLM_URL" LLM_TOKEN="$LLM_TOKEN" LLM_MODEL="$LLM_MODEL" NUM_CONTAINERS=$NUM_CONTAINERS TIMEOUT=$TIMEOUT SKIPCOUNT=$SKIPCOUNT TEST_TIMEOUT=$TEST_TIMEOUT scripts/execution/profuzzbench_exec_all.sh ${TARGET_LIST} ${FUZZER_LIST}